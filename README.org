...
#+begin_src shell
./build/frontend/optmistic_benchmark -ownIp=10.10.1.1 -storage_node -dramGB=10
#+end_src

Starting the client nodes:
#+begin_src shell
./build/frontend/optmistic_benchmark -ownIp=10.10.1.2 -run_for_seconds=5 -nopinThreads -csvFile="optimistic_benchmark_scaleout.csv" -readratios 50 -footer -broken
#+end_src
