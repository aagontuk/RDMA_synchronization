...
#+begin_src shell
./build/frontend/optmistic_benchmark -ownIp=10.10.1.2 -run_for_seconds=10 -pinThreads -sockets 1 -readratios 100 -broken -block_size 64 -worker 16 -all_worker 16
#+end_src
...
Starting the client:
#+begin_src shell
./build/frontend/optmistic_benchmark -ownIp=10.10.1.2 -run_for_seconds=10 -pinThreads -sockets 1 -readratios 100 -rcopt -block_size 64 -worker 16 -all_worker 16
#+end_src
